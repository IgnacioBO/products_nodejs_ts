...
db.system.js.insertOne({
  ...
  value: getNextSequenceValue
});  //Las funciones almacenada en las nuevas versiones de MongoDB estan deprecadas
...
//Crear un usuari que peuda ver todas las BBDD, pero no puede cambiar configuraciones de la base de datos o usuarios
dbAdm.createUser({
  user: "testUser",
  pwd: "12345",
